...
const initialUserData: UserData = {
    cpf: "Conexão inspirada",
    email: "Conexão inspirada",
    name: "Conexão inspirada",
    lname: "Conexão inspirada",
    username: "Conexão inspirada",
    status: "",
    role: "",
    password: "",
    is_active: false,
        ...
        <BasePage username={userData?.username || ''} title="PERFIL">
            ...
            {userData && (
                <UpdatePasswordModal 
                    ...
                    userId={userData.id} // Passa o id do usuário para o modal
                />
            )}
        </BasePage>
    );
