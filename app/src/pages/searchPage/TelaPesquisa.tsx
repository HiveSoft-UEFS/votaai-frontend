...
function TelaPesquisa() {
    ...
    const PollCardWithHeight = (props: {
        title: string;
        description: string;
        creator: string;
        category: string;
            ...
            <div className="resultado">
                <div className="row row-cols-1 fileira">
                    {sortedPolls.map(poll => (
                        <div className="col mb-4" style={{ width: '297.14px', maxHeight: '338px', justifyContent: 'end', alignItems: 'end', padding: '0%', display: 'table' }} key={poll.id}>
                            <PollCard
                                title={poll.title}
                                description=""
                ...
                <div className="row row-eq-height row-cols-4 fileira">
                    {sortedPolls.map(poll => (
                        <div className="col mb-4" key={poll.id}>
