...
export default function Index({open, handleClose}: LoginModalProps) {
            ...
            <div className="modal" onClick={handleClose}>
                <div className="container">
                    ...
                    <div className="input-group" style={{paddingTop: "29.47px", paddingRight: "44px"}}>
                        ...
                        <input type="email" onChange={handleChangeEmail} className="form-control" placeholder="EMAIL"
                               aria-label="EMAIL" aria-describedby="icon-email"/>
                    </div>
                    <div className="input-group" style={{paddingTop: '12px', paddingRight: '44px'}}>
                        <span className="input-group-icon" id="icon-lock-fill" style={{paddingLeft: "5px"}}><img
                            src="https://i.ibb.co/m4z2j43/lock-fill.png/31x31" alt="lock-fill"/></span>
                        <input type="password" onChange={handleChangePassword} className="form-control"
                               placeholder="SENHA" aria-label="SENHA" aria-describedby="icon-lock-fill"/>
                    </div>
                    <div id='error-Password-email' className='error'>
                    </div>
                    <Button className="button-log-into" variant='contained'
                            style={{background: '#04345C'}}>ENTRAR</Button>
                    <div className="hivesoft">
                        <img src="https://i.ibb.co/vBRRQVp/2024-Hive-Soft-Inc.png" alt="2024-Hive-Soft-Inc"/>
                    </div>
                    <div>
                        <button type="button" className="button-close" aria-label="Close" onClick={handleClose}>X</button>
                    </div>
                    <div className='link-password'>
                        <p><a className="link-opacity-50-hover" style={{paddingTop: "0px"}} href="#">Esqueceu a
                            senha?</a></p>
                    </div>
                    <div className="link-register">
                        <p><a className="link-opacity-50-hover" style={{paddingTop: "0px"}} href="#">Não possuo
                            cadastro</a></p>
                    </div>
